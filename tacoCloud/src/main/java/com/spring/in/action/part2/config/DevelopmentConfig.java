...
import com.spring.in.action.part2.model.Ingredient.Type;
...
import com.spring.in.action.part2.repository.UserRepository;
...
public class DevelopmentConfig {
    ...
    public CommandLineRunner dataLoader(IngredientRepository repo,
        ...
        return args -> {
            ...
            userRepo.save(new User("gatis", encoder.encode("password"),
